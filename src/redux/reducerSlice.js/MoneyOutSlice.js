...
export const moneyOutSlice = createSlice({
  name: 'reducerState',
  initialState,
  reducers: {
    moneyOut(state = initialState, action) {
...
export const {moneyOut} = moneyOutSlice.actions;
export default moneyOutSlice.reducer;
