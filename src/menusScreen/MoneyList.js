...
export default function MoneyList({navigation}) {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('AddMoneyIn')}>
          <Icons
          ...
          />
          <Text style={styles.addText}>Add Money In</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
