  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          ...
          <SelectDropdown
            ...
            renderDropdownIcon={salePerson => {
              return (
                <Icons
                  name={salePerson ? 'caret-down-outline' : 'caret-up-outline'}
                  color={'#444'}
                  size={14}
                />
              );
        ...
        <View style={{marginHorizontal: 30}}>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            />
            <Text style={{color: 'black', fontWeight: '400', marginTop: 7}}>
              Cash
            </Text>
          </View>
        ...
        {!isVisibleInvoice ? null : (
          <View
            style={{marginHorizontal: 20, marginTop: 15, marginBottom: 200}}>
            <TextInput
      ...
      <TouchableOpacity
        ...
        onPress={() => [
          handleSaveButton(),
          navigation.navigate('Money In List'),
        ]}>
