...
export default function AddPurchaseReturn({navigation}) {
  ...
  const BillingTermsData = ['Select', 'Net 0', 'Net 1', 'Net 7', 'Net 15', 'Net 30', 'Net 90'];
  ...
  const handleSaveButton = () => {
      ...
      dispatch(purchaseReturnSl({returnInvoice, billDate, billingTerms, billDueDate, purchaseBillNo, purchaseBillDueDate, 
        discountInPercentage, discountInCash, totalAmount, receivedAmount, invoiceNotes}))                    
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Purchase Return No */}
          ...
          <View style={styles.mainView}>
              ...
              <View style={{flexDirection: 'row'}}>
              <SelectDropdown 
                  buttonStyle={{height: 40, width: 180, marginLeft: 10, backgroundColor: 'white'}}
                  ...
                  renderDropdownIcon={billingTerms => {return <Icons name={billingTerms ? 'caret-down-outline' : 'caret-up-outline'} color={'#444'} size={14} /> }}
                  onSelect={(item) => {setBillingTerms(item)}}
            />
              <TouchableOpacity style={styles.calenderDate}>
          ...
          <View style={styles.mainView}>
            <TouchableOpacity style={styles.customerNameButton} onPress={() => navigation.navigate('AddCustomerToBill')}>
          ...
          <TouchableOpacity style={styles.itemToBillButton} onPress={() => navigation.navigate('AddItemToBill')}>
            <Text style={styles.saveText}>Add items to Bill</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.transportButton} onPress={() => navigation.navigate('AddTransportDetails')}>
        ...
        <View style={styles.cashView}>
          ...
          <TextInput 
            ...
            onSubmitEditing={() => discountInPercentageRef.current
        ...
        <View style={styles.cashView}>
          ...
          <TextInput 
            ...
            onSubmitEditing={() => discountInCashRef.current 
                                        && discountInCashRef.current.focus()}
          />
        </View>
        ...
        {/* Invoice Notes Text */}
        {!isVisibleInvoice ? null :<View style={{marginHorizontal: 20, marginTop: 15}}>
          <TextInput 
        ...
        {/* Upload Image */}
        <TouchableOpacity style={styles.uploadButton} onPress={() => alert('Upload Image')}>
      ...
      <TouchableOpacity style={styles.saveButton} 
          onPress={() => [handleSaveButton(), navigation.navigate('Purchase Return List')]}>
