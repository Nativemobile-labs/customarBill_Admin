...
export default function AddNewSale({navigation}) {
  ...
  const handleSaveButton = () => {
    ...
    dispatch(addNewSale({invoiceNo, billDate, billingTerms, billDueDate, selectedState, 
      discountInPercentage, discountInCash,totalAmount, receivedAmount, invoiceNotes }))
      handlePDiscount(); 
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Save Button */}
      <TouchableOpacity style={styles.saveButton} onPress={() => [handleSaveButton(),navigation.navigate('Sale List')]}>
