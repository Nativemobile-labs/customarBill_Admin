...
export default function AddExpense({navigation}) {
  ...
  const selectedDataField = ['Select', 'Add Category', 'Accounting Fees', 'Annual Maintenance charge', 'Consulting Charges',
                                 'Education and Training', 'Employee Salary', 'Fuel', 'Insurance', 'Interest Expense',
                                'Legal Charges', 'Marketing', 'Meals and Entertainment', 'Miscellaneous Expense', 'Office Supply',
                                'Payment Processing Fees', 'Phone and Internet', 'Power and Utility', 'Refund from Vendor', 
                                'Rent', 'Repair and Maintenance', 'Subscriptions', 'Transfer to own account', 'Others'];
  ...
  const handleSaveButton = () => {
    ...
    dispatch(expense({expenseNo, expenseDate, billingTerms, totalAmount, amountPaid, invoiceNotes}));
  }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Expense Number */}
        ...
        {/* Invoice Notes Text */}
        {!isVisibleInvoice ? null :<View style={{marginHorizontal: 20, marginTop: 15, marginBottom: 150}}>
          <TextInput 
      ...
      <TouchableOpacity style={styles.saveButton} 
            onPress={() => [handleSaveButton(), navigation.navigate('Expense List')]}>
