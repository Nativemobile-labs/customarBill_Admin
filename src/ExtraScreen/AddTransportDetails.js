  ...
  const handleSaveButton = async () => {
   ...
   await dispatch(
    ...
    await auth().onAuthStateChanged(user => {
      const uid = user.uid;
      firestore().collection("AdminUser").doc(uid).set({
        Transport_Labour: labourTransport,
        Purchase_Labour: purchaseOrder,
        Challan_Number: challanNumber,
        Bill_Number:eBillNumber,
        Bill_Date:eBillDate,
        Transporter_Name:transporterName,
        Vehicle_Number:vehicleNumber,
        Transport_Distance:transportDistance,
        Delivery_Location:deliveryLocation,
        Delivery_Date:deliveryBillDate,
        Note_DeliVery:notesInputText,
      })
    })
  };
        ...
        <View style={styles.mainView}>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <TextInput
              ...
              onSubmitEditing={() =>
                labourTransportRef.current && labourTransportRef.current.focus()
              }
            />
          </View>
          ...
          <View style={{flexDirection: 'row', marginTop: 10}}>
            ...
            <TextInput
              ...
              onSubmitEditing={() =>
                purchaseOrderRef.current && purchaseOrderRef.current.focus()
              }
            />
          </View>
          ...
          <View style={{flexDirection: 'row', marginTop: 10}}>
            ...
            <TextInput
              ...
              onSubmitEditing={() =>
                challanNumberRef.current && challanNumberRef.current.focus()
              }
            />
          </View>
        ...
        <View style={{marginHorizontal: 20}}>
          <TouchableOpacity
            ...
            onPress={() => [
              ...
              setTransportIsVisible(!transportIsVisible),
            ]}>
            <Text style={{color: '#008AD0', fontWeight: 'bold'}}>
              {' '}
              Transport Details
            </Text>
            <Icons
              name={
                transportDetails ? 'caret-down-outline' : 'caret-up-outline'
              }
              color={'#444'}
              size={14}
            ...
            <View>
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <TextInput
                  ...
                  onSubmitEditing={() =>
                    transporterNameRef.current &&
                    transporterNameRef.current.focus()
                  }
                />
              </View>
              ...
              <View style={{flexDirection: 'row', marginTop: 10}}>
                ...
                <TextInput
                  ...
                  onSubmitEditing={() =>
                    vehicleNumberRef.current && vehicleNumberRef.current.focus()
                  }
                />
              </View>
