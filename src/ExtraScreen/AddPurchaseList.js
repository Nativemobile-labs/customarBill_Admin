...
export default function AddPurchaseList({navigation}) {
  ...
  const handleSaveButton = async () => {
    ...
    await auth().onSubmitEditing(user => {
      const uid = user.uid;
      firestore()
        ...
        .set({
          ...
          Cash_Discount_Per: cashDiscountPer,
          Cash_Discount_R: cashDiscountRupee,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View
          ...
          <TextInput
            ...
            onSubmitEditing={() =>
              cashDiscountPerRef.current && cashDiscountPerRef.current.focus()
            }
          />
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => setNoteIsVisible(!noteIsVisible)}>
        ...
        {!noteIsVisible ? null : (
          <View
            style={{marginHorizontal: 20, marginTop: 20, marginBottom: 200}}>
            <TextInput
      ...
      <TouchableOpacity
        ...
        onPress={() => [
          handleSaveButton(),
          // navigation.navigate('Purchase List'),
        ]}>
